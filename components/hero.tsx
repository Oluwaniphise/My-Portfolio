      ...
      <div className="space-y-4 max-w-3xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
          ...
          <Button
            ...
            size="lg" className="px-8 transition-all duration-300 hover:scale-105">
            View My Work
          </Button>
          <a href="https://drive.google.com/file/d/10wy1BRvpZSLJUXgMl56LlNBI9rTlILBo/view?usp=sharing">
